...
| [Bàn giao SV3 → SV1 Tuần 3](sv3_sv1_week3_model_handoff.md) | Gói FP32 `mitdb-week3-fp32-20260925-v1` verify PASS, boundary P2 đã được SV3/SV1 xác nhận; package review/MCU validation của SV1 PENDING. |
